        ...
        <section className="container py-10 md:py-16 max-w-3xl">
            ...
            <div className="space-y-6">
                ...
                <Section icon={ShieldCheck} title="4. Manual Review Process">
                    <p>
                        All refund requests are manually reviewed by the ZverTs admin team. We
                ...
                <Section icon={Clock} title="5. Refund Processing Time">
                    <p>
                        ...
                        <span className="text-foreground font-medium">3–7 business days</span>{" "}
                ...
                <Section icon={AlertTriangle} title="6. Fraud Prevention">
                    <p>
                        ZverTs monitors suspicious payment activity. Fraudulent refund claims or
                        fake transaction submissions may result in{" "}
