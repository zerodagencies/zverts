            ...
            <section className="container py-24 md:py-32 border-t border-border/40">
                ...
                <div className="mt-16 grid gap-px overflow-hidden rounded-2xl border border-border/60 bg-border/40 sm:grid-cols-2 lg:grid-cols-3">
                    {[
                        {
                            icon: Lock,
                            title: "Sequential Modules",
                            body: "Each lesson unlocks only after the previous is completed.",
                        },
                        {
                            icon: BarChart3,
                            title: "Smart Tracking",
                            body: "Real watch time recorded server-side every few seconds.",
                        },
                        {
                            icon: Brain,
                            title: "MCQ System",
                        ...
                        },
                        {
                            icon: Gem,
                            title: "Gems & XP",
                            body: "Earn rewards for every completed module and quiz.",
                        },
                        {
                            icon: CalendarCheck,
                            title: "Attendance",
                            body: "Build a daily streak by showing up to learn.",
                        },
                        {
                            icon: LineChart,
                            title: "Analytics Dashboard",
                            body: "Visualize your progress, streaks and completion rate.",
                        },
                    ].map((f) => (
                        <div
                            key={f.title}
                ...
                <div className="grid items-center gap-16 lg:grid-cols-2">
                    <div>
                        ...
                        <p className="mt-6 text-muted-foreground leading-relaxed max-w-md">
                            Track streaks, XP, completion rate and weekly watch time in one calm,
                            focused view. No noise — just signal.
                        </p>
        ...
        <div className="relative">
            ...
            <div className="rounded-2xl border border-border/70 bg-card/60 backdrop-blur p-5 shadow-2xl">
                ...
                <div className="flex items-center justify-between border-b border-border/50 pb-3">
                    ...
                    <div className="text-[10px] text-muted-foreground">zverts.app / dashboard</div>
                    <div className="w-8" />
                </div>
